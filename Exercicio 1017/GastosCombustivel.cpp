...
Entrada = O arquivo de entrada contém dois inteiros. O primeiro é o tempo gasto na viagem (em horas) e o segundo é a velocidade média 
...
int main(){
    ...
    cout << setprecision(3) << gasto << endl;
    return 0;
}
