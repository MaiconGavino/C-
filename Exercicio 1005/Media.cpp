...
Saída = Calcule e imprima a variável MEDIA conforme exemplo abaixo, com 5 dígitos após o ponto decimal e com um espaço em branco antes e 
depois da igualdade. Utilize variáveis de dupla precisão (double) e como todos os problemas, não esqueça de imprimir o fim de 
...
int main() {
      double primeiraEntrada, segundaEntrada, media; 
      cin >> primeiraEntrada;
      cin >> segundaEntrada;
      media = (primeiraEntrada * 3.5 + segundaEntrada * 7.5)/(11);
      cout << fixed;
      cout.precision(5);
